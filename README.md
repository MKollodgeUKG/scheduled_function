...
| ingress\_settings | The ingress esttings for the Cloud Function. Allowed values are ALLOW\_ALL, ALLOW\_INTERNAL\_AND\_GCLB and ALLOW\_INTERNAL\_ONLY. | `string` | `ALLOW\_ALL` | no |
